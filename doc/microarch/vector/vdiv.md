...
- `VLENB/2` instances of 8-bit dividers (where VLEN = 128 bits)

- `VLENH/2` instances of 16-bit dividers (where VLEN = 128 bits)

- `VLENW` instances of 32-bit dividers (where VLEN = 128 bits)
...
**Provenance & Traceability** - **Verified As Of:** 2026-08-03 - **Upstream Commit:** [1126ed3fa244b38ee06fa002a5c640df9dec36f4](https://github.com/google/coralnpu/commit/1126ed3fa244b38ee06fa002a5c640df9dec36f4) - **Primary Source(s):** `hdl/verilog/rvv/design/rvv_backend_div.sv`, `hdl/verilog/rvv/design/rvv_backend_div_unit.sv` - **Disclaimer:** AI-generated/assisted; RTL is the source of truth.
