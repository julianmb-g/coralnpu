...
> [!NOTE]
> The internal fabric uses a custom `FabricIO` interface and is agnostic to external bus protocols. External protocols like **AXI4** or **TLUL** are handled by dedicated bridges and wrappers (see [AXI Slave](axi_slave.md) and [Interconnects](interconnects.md)).
...
**Provenance & Traceability** - **Verified As Of:** 2026-08-03 - **Upstream Commit:** [1126ed3fa244b38ee06fa002a5c640df9dec36f4](https://github.com/google/coralnpu/commit/1126ed3fa244b38ee06fa002a5c640df9dec36f4) - **Primary Source(s):** `hdl/chisel/src/coralnpu/scalar/Lsu.scala`, `hdl/chisel/src/coralnpu/Fabric.scala` - **Disclaimer:** AI-generated/assisted; RTL is the source of truth.
