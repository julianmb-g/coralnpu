...
## LSU unaligned vector access splitting

Unaligned vector transactions that cross 16-byte (128-bit) cache line boundaries are split by the LSU into multiple physical memory transactions. The split mechanism uses the address and mask generator FSM to decompose the request, delaying the `last` acknowledge to the RvvCore until both split transactions have been serviced.

[Source: `/hdl/chisel/src/coralnpu/scalar/Lsu.scala`]
...
| rvv2lsu.vregfile.valid | Bool              | If there is valid data from the vector register file.             |
...
**Provenance & Traceability** - **Verified As Of:** 2026-08-03 - **Upstream Commit:** [1126ed3fa244b38ee06fa002a5c640df9dec36f4](https://github.com/google/coralnpu/commit/1126ed3fa244b38ee06fa002a5c640df9dec36f4) - **Primary Source(s):** `/hdl/chisel/src/coralnpu/scalar/Lsu.scala` - **Disclaimer:** AI-generated/assisted; RTL is the source of truth.
