...
// TODO: b/12345678 - Add two inputs buffers of 8 uint32_t's (input1_buffer, input2_buffer)
// TODO: b/12345678 - Add one output buffer of 8 uint32_t's (output_buffer)

int main(int argc, char** argv) {
  // TODO: b/12345678 - Add code to element wise add/subtract from input1_buffer and
...
to generate `coralnpu_program.elf`.
...
+       "coralnpu_hw/tests/cocotb/tutorial/coralnpu_program.elf")
...
**Provenance & Traceability** - **Verified As Of:** 2026-08-03 - **Upstream Commit:** [1126ed3fa244b38ee06fa002a5c640df9dec36f4](https://github.com/google/coralnpu/commit/1126ed3fa244b38ee06fa002a5c640df9dec36f4) - **Primary Source(s):** `tests/uvm/tb/coralnpu_tb_top.sv` - **Disclaimer:** AI-generated/assisted; RTL is the source of truth.
