...
int main() {
  ...
  asm volatile("vsetvli zero, %[vl], e32, m1, ta, ma;"
               "vle32.v v0, (%[raw_a]);"
               "vle32.v v1, (%[raw_b]);"
               "csrw frm, %[frm_val];"
               "vfmul.vv v2, v0, v1;"
               "vse32.v v2, (%[res_frm]);"
               :
               : [frm_val] "r"(3), [vl] "r"(vl), [raw_a] "r"(raw_a),
                 [raw_b] "r"(raw_b), [res_frm] "r"(res_frm)
               : "v0", "v1", "v2", "memory");
  ...
  asm volatile("vsetvli zero, %[vl], e32, m1, ta, ma;"
               ...
               "vse32.v v2, (%[res_fcsr]);"
               :
               : [fcsr_val] "r"(0x60), [vl] "r"(vl), [raw_a] "r"(raw_a),
                 [raw_b] "r"(raw_b), [res_fcsr] "r"(res_fcsr)
               : "v0", "v1", "v2", "memory");
