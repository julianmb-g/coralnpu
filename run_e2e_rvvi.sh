...
podman run --userns=keep-id:uid=1000,gid=1000 --pids-limit=-1 -it --rm -v $PWD:$PWD -w $PWD localhost/coralnpu bazel run //tests/verilator_sim:core_rvvi_sim -- $PWD/rvvi.elf
